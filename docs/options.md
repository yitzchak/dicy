...
-   **Default Value:** none
-   **Commands:** all
-   **Command Line Interface:**  `--ignore-rules <ignoreRules>`
...
-   **Default Value:** none
-   **Commands:** [build][]
-   **Command Line Interface:**  `--output-directory <outputDirectory>`, `-o <outputDirectory>`
...
-   **Default Value:** `pdf`
-   **Commands:** [build][]
-   **Command Line Interface:** `--output-format <outputFormat>`, `-f <outputFormat>`
