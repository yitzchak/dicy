...
export default class ParseLaTeXFileListing extends Rule {
  ...
  async initialize () {
    await this.getResolvedOutput(':dir/:base-ParsedLaTeXFileListing', this.firstParameter)
  }

  async run () {
    const parsedFile = await this.getResolvedOutput(':dir/:base-ParsedLaTeXFileListing', this.firstParameter)
